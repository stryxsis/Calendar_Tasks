...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-[#1e1f20] dark:via-[#1e2329] dark:to-[#262d3f] min-h-screen font-inter p-3">
  ...
  <header class="mx-auto max-w-7xl flex flex-col gap-6 mb-8">
    ...
    <nav class="flex justify-end gap-3">
      <button class="px-3 py-2 bg-black border-1 border-slate-200 dark:border-slate-700 rounded-xl">
        <svg class="w-4 h-4 fill-none stroke-current stroke-1 lucide lucide-bell-icon lucide-bell" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          <path d="M10.268 21a2 2 0 0 0 3.464 0" />
          <path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326" />
        </svg>
      </button>
      <button class="px-3 py-2 bg-black border-1 border-white rounded-xl">
        <svg class="w-4 h-4 fill-none stroke-current stroke-1 lucide lucide-bell-icon lucide-bell" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
  ...
  <main class="mx-auto max-w-7xl">
    ...
    <div class="border-1 border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
      ...
      <div class="bg-gradient-to-r from-white to-slate-50 dark:from-neutral-950 dark:to-zinc-900 p-3 flex flex-col items-center">
        <div class="w-fit min-[426px]:w-full min-[426px]:flex min-[426px]:justify-between">
          ...
          <div class="flex justify-center h-10">
            <div class="text-xs flex p-1 bg-[#202326] rounded-xl font-medium gap-1">
              <button class="bg-blue-600 px-3 py-2 rounded-lg flex gap-1.5">
                <span>
              ...
              <button class="px-3 py-2 rounded-lg flex gap-1.5">
                <span>
        ...
        <div class="w-full flex justify-between items-center mt-2">
          <button id="buttonPrev" class="px-3 py-2 bg-black border-1 border-white rounded-xl">
          ...
          <!-- TODO: Implementare i mesi automatici -->
          <h2 id="monthYear"></h2>
          <button id="buttonNext" class="px-3 py-2 bg-black border-1 border-white rounded-xl">
